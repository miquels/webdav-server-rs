...
extern {
    fn fs_quota_linux_ext(device: *const c_char, id: c_int, do_group: c_int,
                          bytes_used: *mut u64,
                          bytes_limit: *mut u64,
                          files_used: *mut u64,
                          files_limit: *mut u64) -> c_int;
    fn fs_quota_linux_xfs(device: *const c_char, id: c_int, do_group: c_int,
                          bytes_used: *mut u64,
                          bytes_limit: *mut u64,
                          files_used: *mut u64,
                          files_limit: *mut u64) -> c_int;
    fn fs_quota_nfs(host: *const c_char, path: *const c_char,
                    nfsvers: *const c_char,
                    id: c_int, do_group: c_int,
                    bytes_used: *mut u64,
                    bytes_limit: *mut u64,
                    files_used: *mut u64,
                    files_limit: *mut u64) -> c_int;
    ...
    pub fn user<P: AsRef<Path>>(uid: u32, path:  P) -> Result<FsQuota, FqError> {
        ...
        let rc = match fst {
            FsType::LinuxExt => {
                ...
                unsafe { fs_quota_linux_ext(path.as_ptr(), id, 0,
            ...
            FsType::LinuxXfs => {
                let path = CString::new(entry.device.as_bytes())?;
                unsafe { fs_quota_linux_xfs(path.as_ptr(), id, 0,
                            &mut bytes_used as *mut u64,
                            &mut bytes_limit as *mut u64,
                            &mut files_used as *mut u64,
                            &mut files_limit as *mut u64)
            ...
            FsType::Nfs => {
                ...
                unsafe { fs_quota_nfs(host.as_ptr(), path.as_ptr(),
                            fstype.as_ptr(), id, 0,
                            &mut bytes_used as *mut u64,
                            &mut bytes_limit as *mut u64,
                            &mut files_used as *mut u64,
